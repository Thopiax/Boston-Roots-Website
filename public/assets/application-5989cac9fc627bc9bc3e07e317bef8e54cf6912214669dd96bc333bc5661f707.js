...
(function() {
  var addNavToController, setBackgroundSize, setProfilePicsSize;

  $(document).ready(function() {
    var home, just_started, mission, nav, nav_a, nav_brand, nav_brand_l, nav_drop, nav_height, win_top_above;
    just_started = true;
    ...
    $(".profile", "#team").each(function(i, e) {
      console.log($("img", e));
      return $("img", e).on("load", function() {
        return $(e).height($(e).width());
      });
    });
    $(window).on("load", function() {
      return just_started = true;
    });
    ...
    return $(window).on("resize load", function() {
      ...
      addNavToController("team", controller).duration("70%");
      addNavToController("contact", controller).triggerHook("0.5");
      return setProfilePicsSize();
    });
  });

  addNavToController = function(name, controller) {
    return new ScrollMagic.Scene({
      triggerElement: "#" + name,
      duration: "100%"
    }).setClassToggle("#nav" + name, "active").addTo(controller);
  };

  setBackgroundSize = function(div, img_ratio) {
    var bg_size, cnt_ratio, div_height, div_width;
    bg_size = "";
  ...
  setProfilePicsSize = function() {
    return $(".profile", "#team").each((function(_this) {
      return function(i, e) {
        if ($(e).height() !== $(e).width()) {
          return $(e).height($(e).width());
        }
