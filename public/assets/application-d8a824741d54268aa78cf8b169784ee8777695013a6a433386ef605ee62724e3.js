...
(function() {
  var addNavToController, setBackgroundSize;

  $(document).on("turbolinks:load", function() {
    var contact, dwnarr, dwnarr_icon, home, mission, nav, nav_brand, team;
    home = $("#home");
    mission = $("#mission");
    contact = $("#contact");
    team = $("#team");
    ...
    if (home.length) {
      ...
      new ScrollMagic.Scene({
        offset: -100,
        duration: "100%"
      }).setClassToggle("nav", "hidden").addTo(controller);
      dwnarr_icon.velocity("fadeIn", {
        duration: 3000
      });
      dwnarr_icon.velocity({
        translateY: '10px'
      }, {
        duration: 750,
        loop: true
      ...
      return $("#contactSubmit").click(function() {
        return $("#contactSubmit").velocity({
          borderRadius: "25px",
          width: "45px",
          paddingLeft: "0",
          paddingRight: "0",
