...
(function() {
  var addNavToController, scrollBecauseOf, setBackgroundSize;

  $(document).on("turbolinks:load", function() {
    var home, just_started, mission, nav, nav_a, nav_brand_l, nav_height, win_top_above;
    just_started = true;
    ...
    return $(window).on("resize load", function() {
      ...
      return addNavToController("contact", controller);
    });
  });

  scrollBecauseOf = function(thing) {
    return thing.on("click", function() {
      var target;
      target = $(this).attr('to');
